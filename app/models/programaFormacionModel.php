...
class ProgramasFormacionModel extends BaseModel
{
    public function __construct(
        ...
        parent::__construct();
        $this->table = "programas_formacion";
    }
    ...
    public function editProgramaFormacion()
    {
        try {
    ...
    public function deleteProgramaFormacion()
    {
        try {
