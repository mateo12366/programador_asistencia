...
<body class="bg-[#f4f6ff] min-h-screen p-6">
  <div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
      <!-- Crear Programas -->
      <a href="#" data-bs-toggle="modal" data-bs-target="#modalProgramas" class="bg-white shadow-md rounded-lg p-4 flex items-center gap-4 hover:shadow-lg transition">
      ...
      <!-- Crear Ambientes -->
      <a href="#" data-bs-toggle="modal" data-bs-target="#modalAmbiente" class="bg-white shadow-md rounded-lg p-4 flex items-center gap-4 hover:shadow-lg transition">
      ...
      <!-- Crear Fichas -->
      <a href="#" data-bs-toggle="modal" data-bs-target="#modalFicha" class="bg-white shadow-md rounded-lg p-4 flex items-center gap-4 hover:shadow-lg transition">
      ...
      <!-- Crear Instructores -->
      <a href="#" data-bs-toggle="modal" data-bs-target="#modalInstructor" class="bg-white shadow-md rounded-lg p-4 flex items-center gap-4 hover:shadow-lg transition">
      ...
      <!-- Crear Aprendices -->
      <a href="#" data-bs-toggle="modal" data-bs-target="#modalEstudiante" class="bg-white shadow-md rounded-lg p-4 flex items-center gap-4 hover:shadow-lg transition">
      ...
      <!-- Crear Clases -->
      <a href="#" data-bs-toggle="modal" data-bs-target="#modalClase" class="bg-white shadow-md rounded-lg p-4 flex items-center gap-4 hover:shadow-lg transition">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-start">
            <button type="button" class="btn btn-primary bg-purple-600 border-purple-600 hover:bg-purple-700 hover:border-purple-700">
